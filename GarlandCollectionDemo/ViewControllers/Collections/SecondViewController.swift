...
class SecondViewController: GarlandViewController {
    ...
    override func preparePresentingToRight() {
        let secondViewController = ViewController.init(nibName: "ViewController", bundle: nil)
...
extension SecondViewController: UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    func scrollViewDidScroll(_ scrollView: UIScrollView) {
        ...
        if headerView.frame.height < GarlandConfig.shared.cardsSize.height {
            ...
            self.headerView.round(corners: [.topLeft, .topRight], radius: GarlandConfig.shared.cardRadius)
        } else {
